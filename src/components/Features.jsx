            ...
            <div className="screen-max-width">
                <div className="mb-12 w-full">
                    ...
                    <div className='flex flex-col justify-center items-center overflow-hidden'>
                        <div className="mt-32 bm-24 pl-24 ">
                        ...
                        <div className="flex-center flex-col sm:px-10">
                            <div className="relative h-[50vh] w-full flex items-center">
                                <video playsInline id='exploreVideo' className='w-full h-full object-cover object-center mt-10'
                                    preload='none' muted autoPlay ref={videoRef}>
                                    <source src={exploreVideo} type='video/mp4' />
                                </video>
                            </div>
                            <div className='flex flex-col w-full relative'>
                                <div className='feature-video-container mt-10'>
                                ...
                                <div className='feature-text-container'>
                                    ...
                                    <div className='flex-1 flex-center'>
                                        <p className='feature-text g_text'>
                                            titanium on of the best strength-to-weight ratios of any metal , making these our  {' '}
                                            <span className='text-white'>
